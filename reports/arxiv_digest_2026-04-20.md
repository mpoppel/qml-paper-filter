...
### [Optimal algorithmic complexity of inference in quantum kernel methods](http://arxiv.org/abs/2604.15214v2)
...
[View on arXiv](http://arxiv.org/abs/2604.15214v2) | [PDF](https://arxiv.org/pdf/2604.15214v2)
...
### [Bridge the Gap between Classical and Quantum Neural Networks with Residual Connections](http://arxiv.org/abs/2604.15626v1)
**Authors:** Junxu Li  
**Published:** 2026-04-17  
**Updated:** 2026-04-17  
**Categories:** quant-ph  

**Abstract:** We introduce a Hybrid Quantum Residual Network (HQRN) and establish an exact functional correspondence between its state evolution and the dynamics of classical networks with residual connections. When inputs are restricted to the computational basis, the HQRN reduces to its classical analog, enabling the direct translation of optimized classical weights into quantum unitary operations, effectivel...

[View on arXiv](http://arxiv.org/abs/2604.15626v1) | [PDF](https://arxiv.org/pdf/2604.15626v1)
